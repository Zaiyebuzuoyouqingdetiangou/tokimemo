...
- 验证：79 项测试、290 个脚本语法及运行时绑定；实际提供商出图与真机质量待用户环境验收。详见 `dev/archive/r84.84/verification.md`。
